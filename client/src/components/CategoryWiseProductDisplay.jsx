    ...
    return (
        <div>
            ...
            <div className='relative flex items-center'>
                <div
                    className='flex gap-4 md:gap-6 lg:gap-8 overflow-x-auto scrollbar-hide scroll-smooth px-4 container mx-auto'
                    ref={containerRef}
                >
                    {loading &&
                    ...
                    {!loading &&
                        data.map((p, index) => (
                            <div key={p._id + "CategorywiseProductDisplay" + index} className='flex-shrink-0 w-64'>
                                <CardProduct data={p} />
                            </div>
                        ))
                    }
